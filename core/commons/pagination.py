...
def paginate(query, schema):
    """Return paginated result given queryset and schema

    Args:
        query (flask_sqlalchemy.query.Query): A query object
            that needs to be paginated
        schema (_type_): Schema that is used to generate final output

    Returns:
        dict: A dict with attributes of paginated result
    """
